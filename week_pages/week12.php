...
if(isset($_GET['action']) && $_GET['action'] ==='submitPicks'){
  submitPicks("insert into player values(", 12);
}
if(isset($_GET['action']) && $_GET['action'] ==='edit'){
  if ($_POST['delete']){
    submitPicks("delete from player where name="."'".$_POST['name']."'",-1);
  } else {
    submitPicks("update player set ", 12);
  }
}
?>
<!DOCTYPE html>
...
<body>
  ...
  <table>
    <tr>
      <th>Name</th>
      <th>Total Points</th>
      <?php genTableHeader(12); ?>
    </tr>
    <?php buildTableFromDB(12); ?>
    <tr>
  ...
  <span class="left">
    <a href="week11.php" value="prevWeek">&lt;-prev week</a>
  </span>
  <!--<span class="center">
  ...
  <span class="right">
    <a href="week13.php" value="nextWeek">next week-></a>
  </span>
</body>
</html>
