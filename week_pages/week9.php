...
if(isset($_GET['action']) && $_GET['action'] ==='submitPicks'){
  submitPicks("insert into player values(", 9);
}
if(isset($_GET['action']) && $_GET['action'] ==='edit'){
  if ($_POST['delete']){
    submitPicks("delete from player where name="."'".$_POST['name']."'",-1);
  } else {
    submitPicks("update player set ", 9);
  }
}
?>
<!DOCTYPE html>
...
<body>
  ...
  <table>
    <tr>
      <th>Name</th>
      <th>Total Points</th>
      <?php genTableHeader(9); ?>
    </tr>
    <?php buildTableFromDB(9); ?>
    <tr>
  ...
  <span class="left">
    <a href="week8.php" value="prevWeek">&lt;-prev week</a>
  </span>
  <!--<span class="center">
  ...
  <span class="right">
    <a href="week10.php" value="nextWeek">next week-></a>
  </span>
</body>
</html>
