...
if(isset($_GET['action']) && $_GET['action'] ==='submitPicks'){
  submitPicks("insert into player values(", 17);
}
if(isset($_GET['action']) && $_GET['action'] ==='edit'){
  if ($_POST['delete']){
    submitPicks("delete from player where name="."'".$_POST['name']."'",-1);
  } else {
    submitPicks("update player set ", 17);
  }
}
?>
<!DOCTYPE html>
...
<body>
  ...
  <table>
    <tr>
      <th>Name</th>
      <th>Total Points</th>
      <?php genTableHeader(17); ?>
    </tr>
    <?php buildTableFromDB(17); ?>
    <tr>
  ...
  <span class="left">
    <a href="week16.php" value="prevWeek">&lt;-prev week</a>
  </span>
  <!--<span class="center">
